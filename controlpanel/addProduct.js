...
numberOfColorInputs.addEventListener("change",()=>{
    ...
    if(currentNumberOfInputs>numberOfColors){
        colorInputContainer.removeChild(colorInputContainer.childNodes[currentNumberOfInputs]);
        imgInputContainer.removeChild(imgInputContainer.childNodes[currentNumberOfInputs]);
...
window.addEventListener("load",()=>{
        numberOfColorInputs.value = 1;
        let newColorInput = createColorInput(1);
        let newImgInput = createImgInput(1);
        colorInputContainer.appendChild(newColorInput);
        imgInputContainer.appendChild(newImgInput);
